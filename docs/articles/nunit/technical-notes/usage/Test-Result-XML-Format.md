...
* **Contained Elements:** [`<environment>`](#environment), [`<settings>`](#settings), [`<properties>`](#properties), [`<reason>`](#reason), [`<failure>`](#failure), [`<output>`](#output), [`<attachments>`](#attachments), [`<test-suite>`](#test-suite), [`<test-case>`](#test-case* **Attributes**
