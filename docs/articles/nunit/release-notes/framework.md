...
* [3869](https://github.com/nunit/nunit/issues/3869) Copyright notices for third-party code. Thanks to [Lennart Bruggemann](https://github.com/lennartb-) for [PR 4444](https://github.com/nunit/nunit/pull/4444)
...
* [3475](https://github.com/nunit/nunit/issues/3475) Our XML comments are using `<code>` (block element) instead of `<c>` (inline element)
