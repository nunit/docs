...
- **Assembly** - Sets the default UI culture for all tests in the assembly
- **Test Fixture (Class)** - Sets the UI culture for all tests in the fixture
- **Test Method** - Sets the UI culture for a specific test
