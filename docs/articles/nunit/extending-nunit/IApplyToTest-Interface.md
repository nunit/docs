...
* [`CategoryAttribute`](xref:category-attribute)
* `CombiningStrategyAttribute`
* [`CultureAttribute`](xref:cultureattribute)
* [`ExplicitAttribute`](xref:explicitattribute)
* [`IgnoreAttribute`](xref:ignoreattribute)
* [`OrderAttribute`](xref:orderattribute)
* [`PlatformAttribute`](xref:platformattribute)
* [`PropertyAttribute`](xref:propertyattribute) (and, through it, a large number of derived attributes)
* [`RequiresThreadAttribute`](xref:requiresthread-attribute)
* [`TestAttribute`](xref:testattribute)
* [`TestFixtureAttribute`](xref:testfixtureattribute)
