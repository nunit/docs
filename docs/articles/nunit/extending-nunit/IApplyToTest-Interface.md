...
* [`CategoryAttribute`](xref:attribute-category)
* `CombiningStrategyAttribute`
* [`CultureAttribute`](xref:attribute-culture)
* [`ExplicitAttribute`](xref:attribute-explicit)
* [`IgnoreAttribute`](xref:attribute-ignore)
* [`OrderAttribute`](xref:attribute-order)
* [`PlatformAttribute`](xref:attribute-platform)
* [`PropertyAttribute`](xref:attribute-property) (and, through it, a large number of derived attributes)
* [`RequiresThreadAttribute`](xref:attribute-requiresthread)
* [`TestAttribute`](xref:attribute-test)
* [`TestFixtureAttribute`](xref:attribute-testfixture)
