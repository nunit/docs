...
The 4.0 version of the NUnit3TestAdapter has a rewritten discovery mechanism and also other redesigns/refactorings done.  This setting let you switch back to the old form of discovery, using the setting `Legacy`.  The default value is `Current`.  
