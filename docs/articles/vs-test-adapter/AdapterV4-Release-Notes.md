...
The NUnit.Engine has been updated to version 3.13 in this release.  See [engine release notes](https://docs.nunit.org/articles/nunit/release-notes/console-and-engine.html) for details.
