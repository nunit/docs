...
This release has a series of enhancements and bugfixes.  It has been preceeded by two beta releases (beta.1 and beta.2) published on nuget.org.
...
The ability to set custom codefilepaths can be useful with data driven tests, where you want to point to the datafile (and linenumber therein) instead of usually trivial test case. 
