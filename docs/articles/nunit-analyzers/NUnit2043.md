...
| Enabled  | True
| Category | Assertion
| Code     | [ComparisonConstraintUsageAnalyzer](https://github.com/nunit/nunit.analyzers/blob/4.12.0/src/nunit.analyzers/ConstraintUsage/ComparisonConstraintUsageAnalyzer.cs)
