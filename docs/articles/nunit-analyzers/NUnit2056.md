...
| Enabled  | True
| Category | Assertion
| Code     | [UseAssertEnterMultipleScopeAnalyzer](https://github.com/nunit/nunit.analyzers/blob/4.12.0/src/nunit.analyzers/UseAssertEnterMultipleScope/UseAssertEnterMultipleScopeAnalyzer.cs)
